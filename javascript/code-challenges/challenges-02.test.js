...
const addOne = (arr) => {
  // Solution code here...
  let oneMore = arr.map( function (value, idx){
    return value + 1;
  });
  return oneMore
...
const addQuestion = (arr) => {
  // Solution code here...
let question = arr.map( function (value, idx){
  return value + "?";
});
  return question;
};
...
const forLoopTwoToThe = (arr) => {
  // Solution code here...
let secondPower = arr.map( function (value, idx){
  let powerSecond = Math.pow(2,value);
// secondPower.push(powerSecond);
  return powerSecond
...
const forEachTwoToThe = (arr) => {
  ...
  let forEachArray = [];
  arr.forEach((element) => {
    let exponent = Math.pow(2,element);
    forEachArray.push(exponent);
    return exponent;
  });
    return forEachArray
