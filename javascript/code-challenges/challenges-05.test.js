...
const addValues = (arr) => {
  // Solution code here...
  let addedValues = arr.reduce(function(accumulator, value, idx){
...
const addPurchases = (arr) => {
  // Solution code here...
  let purchases = arr.reduce((total, arr) => {
    total = total + arr.purchasePrice
    return total
  }, 0)
  return purchases
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
let elementCounter = arr.reduce((total, arr) => {
  total = total + 1
  return total
}, 0)
...
const returnNames = (arr) => {
  // Solution code here...
  let Jedi = starWarsData.reduce((namesArray, starWarsData) => {
    namesArray.push(starWarsData.name)
    return namesArray
  },[])
  return Jedi
};
...
const reversedString = (str) => {
  ...
  let stringReversed = stringArray.reduce((characters, value) =>{
